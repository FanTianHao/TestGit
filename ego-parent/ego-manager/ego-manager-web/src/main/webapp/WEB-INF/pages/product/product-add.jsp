    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="pull-right">
                <a href="${ctx}/product/list" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="返回"><i class="fa fa-reply"></i></a>
                        ...
                        <div class="tab-pane active" id="tab_tongyong">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>商品名称:</td>
                                    <td>
                                        <input type="text" value="" name="goodName" class="form-control" style="width:550px;"/>
                                ...
                                <tr>
                                    ...
                                    <input type="text" id="originalImg" name="originalImg"/>
                                    <td>
                                      <div class="col-xs-3">
                                      <select name="cat_id" id="cat_id" onchange="get_category_goods(this.value,'cat_id_2','catId');" class="form-control" style="width:250px;margin-left:-15px;">
                                      ...
                                      <div class="col-xs-3">
                                      <select name="cat_id_2" id="cat_id_2" onchange="get_category_goods(this.value,'cat_id_3','catId');" class="form-control" style="width:250px;margin-left:-15px;">
                                        <option value="0">请选择商品分类</option>
                                      </select>
                                      </div>
                                      <div class="col-xs-3">
                                      <select name="cat_id_3" id="cat_id_3" class="form-control" style="width:250px;margin-left:-15px;" onchange="setCatIdAndExtendCarId(this.value, 'catId');">
                                        <option value="0">请选择商品分类</option>
                                      </select>
                                      </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <div class="col-xs-3">
                                      <select name="extend_cat_id" id="extend_cat_id" onchange="get_category_goods(this.value,'extend_id_2','extendCatId');" class="form-control" style="width:250px;margin-left:-15px;">
                                        <option value="0">请选择商品分类</option>
										  <c:forEach items="${gcList}" var="gc">
											  <option value="${gc.id}">${gc.name}</option>
										  </c:forEach>
                                      ...
                                      <div class="col-xs-3">
                                      <select name="extend_id_2" id="extend_id_2" onchange="get_category_goods(this.value,'extend_id_3','extendCatId');" class="form-control" style="width:250px;margin-left:-15px;">
                                        <option value="0">请选择商品分类</option>
                                      </select>
                                      </div>
                                      <div class="col-xs-3">
                                      <select name="extend_id_3" id="extend_id_3" class="form-control" style="width:250px;margin-left:-15px;" onchange="setCatIdAndExtendCarId(this.value, 'extendCatId');">
                                        <option value="0">请选择商品分类</option>
                                      </select>
                                      </div>
                                      <span id="err_cat_id" style="color:#F00; display:none;"></span>
...
-->
                                <tr>
                                    <td>商品品牌:</td>
                                    <td>
									<select name="brandId" id="brand_id" class="form-control" style="width:250px;">
                                ...
                                <tr>
                                    <td>供应商:</td>
                                    <td>
                                        <select name="suppliersId" id="suppliers_id" class="form-control" style="width:250px;">
                    ...
                    <div class="pull-right">
                        ...
                        <button class="btn btn-primary" onclick="ajax_submit_form('addEditGoodsForm','${ctx}/product/save', '${ctx}/product/add', '${ctx}/product/list');" title="" data-toggle="tooltip" type="button" data-original-title="保存">保存</button>
                    </div>
