                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="list-table" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    <tbody>
                                    <c:forEach var="gcv1" items="${goodsCategoryList}">
                                        <tr role="row" align="center" class="1" id="1_1">
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="${ctx}/product/category/edit/${gcv1.id}"><i class="fa fa-pencil"></i></a>
                                        ...
                                        <c:forEach var="gcv2" items="${gcv1.children}">
                                            <tr role="row" align="center" class="2" id="2_12" style="display:none">
                                                ...
                                                <td>
                                                    <a class="btn btn-primary"
                                                       href="${ctx}/product/category/edit/${gcv2.id}"><i
                                                            class="fa fa-pencil"></i></a>
                                                    <a class="btn btn-danger"
                                                       href="javascript:void(0);"onclick="del_fun(this,'${gcv2.id}');"><i
                                                            class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <c:forEach var="gcv3" items="${gcv2.children}">
                                                <tr role="row" align="center" class="3" id="3_100" style="display:none">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary" href="${ctx}/product/category/edit/${gcv3.id}"><i
                                                                class="fa fa-pencil"></i></a>
                                                        <a class="btn btn-danger"
                                                           href="javascript:void(0);"onclick="del_fun(this,'${gcv3.id}');"><i
                                                                class="fa fa-trash-o"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
